...
namespace ResourceServices.Service
{
    public class QuestionDAO
    {
        ...
        public static List<QuestionDTO> GetQuestionByCatalogue(int id)
        {
            ...
            {
                var question = context.Question.Where(ques => ques.CatalogueId == id && ques.IsActive==true).Select(ques => new QuestionDTO(ques, ques.Catalogue.Name, ques.Answer.ToList()));
